...
namespace Aplicacion.LogicaPrincipal.GeneracionComplementoCartaPorte
{
    public class CartaPorteManager
    {
        ...
        //private static string pathXml = @"D:\XML-GENERADOS-CARTAPORTE\CRANE-CP.xml";
        //private static string pathCer = @"D:\Descargas(C)\CertificadoPruebas\Pruebas.cer";
        //private static string pathKey = @"D:\Descargas(C)\CertificadoPruebas\Pruebas.key";
        ...
        {   
            ...
            if (objCfdi.MensajeError == "")
            {
                ...
                //guardar string en un archivo de prueba
        ...
        private RVCFDI33.GeneraCFDI LlenadoCfdi(ComplementoCartaPorte complementoCartaPorte, int sucursalId)
        {
            ...
            //  Agrega el certificado produccion
            ...
            if (impuestoTraladado || impuestoRetenido)
            {
                ...
                foreach (var impuesto in conceptos)
                {
                    ...
                    if (impuesto.Retencion != null)
                    {
                        ...
                        if (impuesto.Retencion.TipoFactor == c_TipoFactor.Tasa )
                        {
                ...
                foreach (var impuesto in conceptos)
                {
                    ...
                    {
                        if(impuesto.Traslado.Importe == 0 && impuesto.Traslado.TasaOCuota == 0)
                        {
                        ...
                        if (impuesto.Traslado.TipoFactor == c_TipoFactor.Tasa && impuesto.Traslado.Importe > 0)
                        {
            ...
            if (mercancias != null)
            {
                if (mercancias.Count > 0)
                {
                    ...
                    foreach (var mercancia in mercancias)
                    {
                        ...
                        /*if (validaMPeligroso.PalabrasSimilares == "")
                        {
                            valorMaterialPeligroso = "";
                        }
                        if (validaMPeligroso.PalabrasSimilares != null && validaMPeligroso.PalabrasSimilares !="")
                        {
                            valorMaterialPeligroso = "No";
                        }*/
            ...
            // genera prueba
            //objCfdi.GeneraXML(pathKey, passwordKey/*"LE02SA04"*/);
            // Genera produccion
