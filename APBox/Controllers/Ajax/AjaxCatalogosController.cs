...
namespace InventorAid.Controllers.Ajax
{
    public class AjaxCatalogosController : Controller
    {
        ...
        {
            var cfdis = _db.ComplementosPago.Where(f => f.ReceptorId == clienteId  && f.FacturaEmitidaId != null).ToList();
        ...
        {
            var cfdis = _db.ComplementoCartaPortes.Where(f => f.ReceptorId == clienteId &&  f.FacturaEmitidaId != null && f.Total > 0).ToList();
            ...
            foreach (var cfdi in cfdis)
            {
                ...
                {
                    Id = cfdi.FacturaEmitida.Id,
                    Desplegado = cfdi.FacturaEmitida.Desplegado
                };
            ...
            return Json(ListCfdiR, JsonRequestBehavior.AllowGet);
        }
